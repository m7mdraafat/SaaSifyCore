...
namespace SaaSifyCore.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251018150002_UpdateDbIndexes")]
    partial class UpdateDbIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SaaSifyCore.Domain.Entities.RefreshToken", b =>
                {
                    ...
                    b.HasIndex("UserId", "IsRevoked", "CreatedAt")
            ...
            modelBuilder.Entity("SaaSifyCore.Domain.Entities.User", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("Email", "TenantId"), new[] { "PasswordHash", "FirstName", "LastName", "Role" });
